...
lShape::lShape(Ogre::SceneManager * mSceneMgr, string mName, string materialName)
{
	alive = true;
	time = 0;
	myName = mName;
...
void lShape::Update(double timeChange, OIS::Keyboard* mKeyboard,vector<vector<vector<Cube*>>>  & array3D,int mainTickValue)
{
...
void lShape::isDropping(vector<vector<vector<Cube*>>> & array3D)
{
		for(int i = 0; i < cubeAmount; i++ )
		{
...
void lShape::rotateRight(double timeChange, OIS::Keyboard* mKeyboard,vector<vector<vector<Cube*>>>  & array3D)
{
		 ...
		 Ogre::Vector3 newPos2 =   Ogre::Vector3(cubes[1]->m_position.x + xDirection,cubes[1]->m_position.y ,cubes[1]->m_position.z + zDirection);
		 cubes[1]->setPosition(newPos2);
		 cubes[1]->targetNode->setPosition(newPos2);
		 ...
		 zDirection = -zDirection;
		  ...
		  Ogre::Vector3 newPos3 =   Ogre::Vector3(cubes[3]->m_position.x + (xDirection),cubes[3]->m_position.y ,cubes[3]->m_position.z + (zDirection));
		 cubes[3]->setPosition(newPos3);
		 cubes[3]->targetNode->setPosition(newPos3);
...
void lShape::rotateLeft(double timeChange, OIS::Keyboard* mKeyboard,vector<vector<vector<Cube*>>>  & array3D)
{
...
void lShape::rotateY(double timeChange, OIS::Keyboard* mKeyboard,vector<vector<vector<Cube*>>>  & array3D)
{
