#ifndef __lShapeOpp_h_
#define __lShapeOpp_h_
...
class lShapeOpp
{
	...
	/*! this is entire class is very similar to lShape although has some different bounds checking a rotation */
	public:
	...
	lShapeOpp(Ogre::SceneManager *, string, string); // constructor 
